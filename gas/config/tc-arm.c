...
do_ct_ct (void)
{
  ...
  inst.instruction |= inst.operands[1].reg << 9;
 //inst.instruction |= inst.operands[0].reg << 9;
 // inst.instruction |= inst.operands[1].reg << 14;
}
...
#define REGSETCT(p,t) \
  ...
  REGNUM(p,32,t), REGNUM(p,33,t), REGNUM(p,34,t), REGNUM(p,35,t), \
  REGNUM(p,36,t), REGNUM(p,37,t), REGNUM(p,38,t), REGNUM(p,39,t), \
  REGNUM(p,40,t), REGNUM(p,41,t), REGNUM(p,42,t), REGNUM(p,43,t), \
  REGNUM(p,44,t), REGNUM(p,45,t), REGNUM(p,46,t), REGNUM(p,47,t), \
  REGNUM(p,48,t), REGNUM(p,49,t), REGNUM(p,50,t), REGNUM(p,51,t)
#define REGSETH(p,t) \
  REGNUM(p,16,t), REGNUM(p,17,t), REGNUM(p,18,t), REGNUM(p,19,t), \
  REGNUM(p,20,t), REGNUM(p,21,t), REGNUM(p,22,t), REGNUM(p,23,t), \
  REGNUM(p,24,t), REGNUM(p,25,t), REGNUM(p,26,t), REGNUM(p,27,t), \
...
static const struct reg_entry reg_names[] =
{
  ...
  /* ARM new integer registers.  */
  REGSETCT(r, RN), REGSETCT(R, RN),
  /* ATPCS synonyms.  */
...
#define THUMB_VARIANT  & arm_ext_v6t2
 ...
 /* V1 instructions with no Thumb analogue at all.  */
  ...
  C3(rscs,	0f00000,	   3, (RR, oRR, SH), arit),
    /* ISO-X instructions.  */
 CE("comp_init", 1000140,  0, (),  noargs),
 CE("cpage_map", 1080140,  0, (),  noargs),
 CE("comp_enter", 1200140,  0, (),  noargs),
 CE("comp_attest", 1280140,  0, (),  noargs),
 CE("cpage_revoke", 1400140,  0, (),  noargs),
 CE("comp_resume", 1480140,  0, (),  noargs),
 CE("comp_leave", 1600140,  0, (),  noargs),
 CE("rct",1680140, 2, (RR, SH),  ct_ct),
