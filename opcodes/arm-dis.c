...
static const struct opcode32 arm_opcodes[] =
{
  ...
  {ARM_EXT_V1, 0xe1000140, 0xffffffff, "comp_init"},
  {ARM_EXT_V1, 0xe1080140, 0xffffffff, "cpage_map"},
  {ARM_EXT_V1, 0xe1200140, 0xffffffff, "comp_enter"},
  {ARM_EXT_V1, 0xe1280140, 0xffffffff, "comp_attest"},
  {ARM_EXT_V1, 0xe1400140, 0xffffffff, "cpage_revoke"},
  {ARM_EXT_V1, 0xe1480140, 0xffffffff, "comp_resume"},
  {ARM_EXT_V1, 0xe1600140, 0xffffffff, "comp_leave"},
  {ARM_EXT_V1, 0xe1680140, 0xfff801f0, "rct%c\t%9-13r, %14-18r"},  
...
static const arm_regname regnames[] =
{
  ...
  { "gcc",  "Select register names used by GCC",
    { "r0", "r1", "r2", "r3", "r4", "r5", "r6", "r7", "r8", "r9", "sl",  "fp",  "ip",  "sp",  "lr",  "pc" , "r16", "r17"}},
  { "std",  "Select register names used in ARM's ISA documentation",
    { "r0", "r1", "r2", "r3", "r4", "r5", "r6", "r7", "r8", "r9", "r10", "r11", "r12", "sp",  "lr",  "pc", "r16", "r17" }},
  { "apcs", "Select register names used in the APCS",
    { "a1", "a2", "a3", "a4", "v1", "v2", "v3", "v4", "v5", "v6", "sl",  "fp",  "ip",  "sp",  "lr",  "pc", "r16", "r17" }},
  { "atpcs", "Select register names used in the ATPCS",
    { "a1", "a2", "a3", "a4", "v1", "v2", "v3", "v4", "v5", "v6", "v7",  "v8",  "IP",  "SP",  "LR",  "PC" , "r16", "r17" }},
  { "special-atpcs", "Select special register names used in the ATPCS",
    { "a1", "a2", "a3", "a4", "v1", "v2", "v3", "WR", "v5", "SB", "SL",  "FP",  "IP",  "SP",  "LR",  "PC" , "r16", "r17"}},
};
